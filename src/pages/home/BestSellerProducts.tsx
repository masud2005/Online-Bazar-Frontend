...
import bestsellerDiscount from "../../assets/banner/hot-sale.jpg";
const products = [
    {
        id: 1,
        name: "Green Apple",
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        {hotDeals.map((p) => (
                            <div
                                key={p.id}
                                className="group flex items-center justify-center gap-2 md:gap-4 p-3 border border-gray-200 rounded-lg hover:shadow hover:border-[#00B207] transition-colors duration-300"
                            >
                                {/* Product Image */}
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        {bestSellers.map((p) => (
                            <div
                                key={p.id}
                                className="group flex items-center justify-center gap-2 md:gap-4 p-3 border rounded-lg hover:shadow relative overflow-hidden hover:border-[#00B207]"
                            >
                                {/* Product Image */}
                                <div className="w-16 h-16 flex items-center justify-center">
